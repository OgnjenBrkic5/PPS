...
uses
  ...
  FMX.Controls.Presentation, FMX.Layouts, DataModule, StanjeAlata;
...
type
  TFRadnickiNalog = class(TForm)
    ...
    procedure StanjeAlataBtnClick(Sender: TObject);
  private
...
procedure TFRadnickiNalog.StanjeAlataBtnClick(Sender: TObject);
begin
      FStanjeAlata:= TFStanjeAlata.Create(self);
      FStanjeAlata.Show;
      self.Hide;
end;
